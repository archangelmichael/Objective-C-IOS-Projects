...
- (int)zoomLevel {
    ...
    double leftPixel = [MKMapView longitudeToPixelSpaceX:leftLongitude]; // longitude:leftLongitude toMapPixelSpaceX:map];
    double rightPixel = [MKMapView longitudeToPixelSpaceX:rightLongitude]; // [self longitude:rightLongitude toMapPixelSpaceX:map];
